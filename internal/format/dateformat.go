...
// cells against: formats[field], if present, else defaultFormat. The csv
// and xlsx
...
// the field's own Kind: value.DefaultDateFormat for Date,
// value.DefaultDateTimeFormat for DateTime. Every other Kind
