...
// NewFilterExpr builds a Filter from a checked ast.Expr. Module 2 chose
// to defer this until eval existed (module 7). The re-pull loop in Next
// below is untouched; only how a predicate is evaluated changed.
